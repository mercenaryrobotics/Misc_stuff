...
use <Pulleys2/parametric_pulleys.scad>
/* [Action] */
$Action = 11; //[0: Nothing, 1:Trajectory sim, 2:Launcher V1, 3:Launcher V2, 4:Full bot V1, 5: Ball intake, 6:ControlWheelManipulator, 7:Hook lifter, 9:Shooter angler, 10:Print, 11:ShooterAngler2021]

/* [Printables] */
$ToPrint = 5;//[1:ControlDriveMount,2:ControlWheelFrame, 3:ControlPanelServoGear, 4:ShooterAnglerPrint, 5:ControlWheelHubs, 6:CameraPoleMount, 7:CameraLowerGimbal, 8:CameraUpperGimbal, 9:ShooterAnglerPulleys]
...
$CameraWidth = 42;
$WallThickness = 5;
$WeightCavityWidth = 20;
$LowerHeight = 18;
$LowerGimbalHeight = 70;

$LowerWidth = $CameraWidth + $WeightCavityWidth + $WeightCavityWidth + $WallThickness + $WallThickness + $WallThickness + $WallThickness;
$LowerDepth = $CameraWidth + $WallThickness + $WallThickness;
...
$CWShaftDiameter = 0.305;//8mm bolt shaft diameter
$CWShaftClearance = 2.5/25.4;//2.5mm clearance
...
module PrintPart()
{
  ...
  else if ($ToPrint == 2)
  {
    ...
    ShooterAnglerPulleys();
}

module ShooterAnglerPulleySet($PulleyHeight = 11.5, $ShaftDiameter = 8.3)
{
//$PulleyHeight = 6;
//$PulleyHeight = 11.5 for full fit;
  
//Lead screw bore = 8.3
//Motor shaft bore = 6.3
  
//  scale(1/25.4)
  translate([0, 0, 0])
      DoPulley(teeth = 45, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 29, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
  translate([30, 0, 0])
      DoPulley(teeth = 40, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 26.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
  translate([60, 0, 0])
      DoPulley(teeth = 35, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 23.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
  translate([0, 30, 0])
      DoPulley(teeth = 30, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 23.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
  translate([30, 30, 0])
      DoPulley(teeth = 25, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 23.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
  translate([60, 30, 0])
      DoPulley(teeth = 20, profile = "GT2 2mm", motor_shaft = $ShaftDiameter, pulley_t_ht = $PulleyHeight, pulley_b_ht = 8, pulley_b_dia = 23.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);
}

module ShooterAnglerPulleys()
{
  ShooterAnglerPulleySet($PulleyHeight = 11.5, $ShaftDiameter = 8.3);
  translate([0, 60, 0])
    ShooterAnglerPulleySet($PulleyHeight = 6, $ShaftDiameter = 6.3);
}

module CameraHangingMount()
{
  CameraLowerGimbal();
  translate([0, 0, $LowerGimbalHeight - 2])
    CameraUpperGimbal();
}

module CameraLowerGimbal()
{
  //Camera holder
  difference()
  {
    //Main base
    translate([-$LowerWidth / 2, -$LowerDepth / 2, 0])
      cube([$LowerWidth, $LowerDepth, $LowerHeight]);
    //Camera receptical
    translate([-$CameraWidth / 2, -$CameraWidth / 2, $WallThickness])
      cube([$CameraWidth, $CameraWidth, $LowerHeight]);
    //Weight cavities
    translate([(-$WeightCavityWidth / 2) + ($CameraWidth + $WeightCavityWidth + $WallThickness + $WallThickness) / 2, -$CameraWidth / 2, $WallThickness])
      cube([$WeightCavityWidth, $CameraWidth, $LowerHeight]);
    translate([(-$WeightCavityWidth / 2) - ($CameraWidth + $WeightCavityWidth + $WallThickness + $WallThickness) / 2, -$CameraWidth / 2, $WallThickness])
      cube([$WeightCavityWidth, $CameraWidth, $LowerHeight]);
    //Lense opening
    translate([-($CameraWidth - 4) / 2, -($CameraWidth - 4) / 2, -0.5])
      cube([$CameraWidth - 4, $CameraWidth - 4, $WallThickness + 1]);
    //Fixing screw hole
    translate([0, 0, 11])
      rotate(90, [1, 0, 0])
        cylinder(d = 3, h = $LowerDepth + 1, center = true, $fn = 30);
  }
  //Side gimbal supports
  difference()
  {
    translate([-($CameraWidth + $WallThickness + $WallThickness) / 2, -($CameraWidth + $WallThickness + $WallThickness) / 2, $LowerHeight])
      cube([$CameraWidth + $WallThickness + $WallThickness, $CameraWidth + $WallThickness + $WallThickness, $LowerGimbalHeight]);
    translate([-($CameraWidth) / 2, -($CameraWidth + $WallThickness + $WallThickness + 2) / 2, $LowerHeight - 0.1])
      cube([$CameraWidth, $CameraWidth + $WallThickness + $WallThickness + 2, $LowerGimbalHeight + 1]);
    //Gimbal bearings
    translate([($CameraWidth / 2) + 1, 0, $LowerGimbalHeight + $LowerHeight - 10])
      rotate(90, [0, 1, 0])
        cylinder(d = 10, h = 5, $fn = 40);
    mirror([1, 0, 0])
      translate([($CameraWidth / 2) + 1, 0, $LowerGimbalHeight + $LowerHeight - 10])
        rotate(90, [0, 1, 0])
          cylinder(d = 10, h = 5, $fn = 40);
    //Gimbal shaft opening
    translate([0, 0, $LowerGimbalHeight + $LowerHeight - 10])
      rotate(90, [0, 1, 0])
        cylinder(d = 8, h = $LowerWidth, $fn = 40, center = true);
  }
}

module CameraUpperGimbal()
{
    difference()
    {
      union()
      {
        translate([-($CameraWidth - 2) / 2, -10, 0])
          cube([$CameraWidth - 2, 20, 27]);
        translate([0, 0, 5])
          rotate(90, [0, 1, 0])
            cylinder(d = 6, h = $CameraWidth, center = true, $fn = 40);
      }
      //Lower gimbal shaft. Bolt should thread into these holes
      translate([0, 0, 5])
      {
        rotate(90, [0, 1, 0])
          cylinder(d2 = 3.5, d1 = 2.5, h = ($CameraWidth / 2) + 1, $fn = 40);
        rotate(-90, [0, 1, 0])
          cylinder(d2 = 3.5, d1 = 2.5, h = ($CameraWidth / 2) + 1, $fn = 40);
      }
      //Carriage cord opening
      translate([-$CameraWidth / 2, -5/ 2, 10])
        cube([$CameraWidth, 5, 20]);
      //Bearings
      translate([0, -10 + 4.9, 18])
        rotate(90, [1, 0, 0])
          cylinder(d = 10, h = 5, $fn = 40);
      mirror([0, 1, 0])
        translate([0, -10 + 4.9, 18])
      ...
      translate([0, -10 + 4.9, 18])
        rotate(90, [1, 0, 0])
          cylinder(d = 8, h = 25, $fn = 40, center = true);
    }
}

module CameraPoleMount()
{
  $fn = 40;
  $ShaftOpening = 4.3;
  $HeadOpening = 7;
  ...
  difference()
  {
    ...
    //Camera mount holes, vertical
    translate([17/2, 0, 0])
    {
      cylinder(d = $ShaftOpening, h = 25, center = true);
      translate([0, 0, 8])
        cylinder(d = $HeadOpening, h = 20, center = true, $fn = 6);
    }
    translate([-17/2, 0, 0])
    {
      cylinder(d = $ShaftOpening, h = 25, center = true);
    ...
    //Camera stand clamp opening
    translate([0, 0, (20 / 2) + 1])
      rotate(90, [0, 1, 0])
        cylinder(d = $PoleDiameter, h = 60, center = true);
    //Camera stand clamp holes
    translate([0, 17, 0])
      cylinder(d = 4.3, h = 25, center = true);
    translate([0, -17, 0])
      cylinder(d = 4.3, h = 25, center = true);
    //Camera stand clamp holes, bolt heads
    translate([0, 17, -20 + 5])
      cylinder(d = $HeadOpening, h = 20, center = true, $fn = 6);
    translate([0, -17, -20 + 5])
      cylinder(d = $HeadOpening, h = 20, center = true, $fn = 6);
    ...
    translate([17, -17, 0])
      cylinder(d = $ShaftOpening, h = 25, center = true);
    //Cable clamp bolts, bolt heads
    translate([17, 17, 20 - 12])
      cylinder(d = $HeadOpening, h = 20, center = true, $fn = 6);
    translate([17, -17, 20 - 12])
      cylinder(d = $HeadOpening, h = 20, center = true, $fn = 6);
  }
  ...
  translate([30, -25, -10])
    ...
    {
      cube([15, 50, 7]);
      translate([7.5, 25 - 17, 0])
      {
        cylinder(d = $ShaftOpening, h = 30, center = true);
        translate([0, 0, 4])
          cylinder(d = $HeadOpening, h = 20, $fn = 6);
      }
      translate([7.5, 25 + 17, 0])
      {
        cylinder(d = $ShaftOpening, h = 30, center = true);
...
module ShooterAnglerPrint()
{
  ...
  translate([2.3, -0.2, 0])
    rotate(180, [0, 0, 1])
      ShooterAnglerPivotSupport($DoHex = false, $FrameWidth = 1.6, $DoHorizontal = true);
  ShooterAnglerLowerSupport();
  translate([-$SupportSideWidth - $Clearance, 2, 0])
    ShooterAnglerPivotSupport($FrameWidth = $LowerSupportWidth, $VerticalMountSpacing, $DoVertical = true, $DoHorizontal = false);
  translate([1.25, 1.15, 0])
    LeadscrewCollar();
  translate([1.2, 3, .76])
    ShooterAnglerPulleys();
}
...
module LeadscrewCollar()
{
  difference()
  {
    ...
    translate([0, 0, -0.01])
      cylinder(d = 8.15/25.4, h = .6, $fn = 30);
    translate([0, .12, .25])
      rotate(30, [0, 1, 0])
        scale(1/25.4)
          CaptiveBoltOpening($Type = "M2.5", $Units = 1, $Angle = 90, $Orientation = [-1, 0, 0]);
...
module ShooterAngler()
{
  translate([2.4, 3.3, 0])
    rotate(180,[0, 0, 1])
    {
      ...
      translate([1.15, .5, .77])
        scale(1/25.4)
          DoPulley(teeth = 35, profile = "GT2 2mm", motor_shaft = 8.2, pulley_t_ht = 11.5, pulley_b_ht = 8, pulley_b_dia = 23.5, retainer = 1, retainer_ht = 0.5, idler = 0, idler_ht = 1.0, no_of_nuts = 1, m3_dia = 3.4, m3_nut_hex = 1, m3_nut_flats = 5.6, m3_nut_depth = 1.6 + .4, nut_angle = 90, nut_shaft_distance = 0.1);    
    }
  ShooterAnglerLowerSupport();
  translate([-$SupportSideWidth - $Clearance, 2, 0])
...
module ShooterAnglerLowerSupport()
{
  ...
  difference()
  {
    ...
    union()
    {
      ...
      translate([0, $LowerSupportDepth - 1, $LowerSupportHeight])
        cube([$LowerSupportWidth, 1, 1.2]);
    }
    //Leadscrew pulley opening
    translate([($LowerSupportWidth - 1.4) / 2, $LowerSupportDepth - 1.1 , $LowerSupportHeight])
      cube([1.4, 1.2, 0.82]);
    //Motor opening
    translate([$LowerSupportWidth / 2, 1.42, -3.2])
      rotate(0, [0, 1, 0])
        Neverest($Correction = -0.017);//Should be 0.03?
      //cylinder(d = $ShooterAngleMotorD, h = 4, $fn = 20, center = true);
    //Leadscrew bearing openings
    translate([$LowerSupportWidth / 2, 1.42 + $ShaftSpacing, -0.001])
      scale(1/25.4)
        BearingReceptical($Type="608",  $DOversize = .5);
    translate([$LowerSupportWidth / 2, 1.42 + $ShaftSpacing, -0.001 + $LowerSupportHeight + 0.82])
      scale(1/25.4)
        BearingReceptical($Type="608",  $DOversize = .5);
    //Leadscrew opening
    translate([$LowerSupportWidth / 2, 1.42 + $ShaftSpacing, 0])
        cylinder(d = 9/25.4, h = 4, $fn = 30, center = true);
    //Motor clamp gap
...
module ShooterAnglerPivotSupport($DoHex = false, $DoVertical = false, $DoHorizontal = false)
{
  ...
  difference()
  {
    ...
    translate([$SupportSideWidth, -0.01, -0.01])
      cube([$FrameWidth + ($Clearance * 2), $FrameClearanceDepth + 0.1, $SupportHeight + 0.02]);
    //Pivot shaft opening
    translate([(($FrameWidth + $LeadscrewTNutOuterD) / 2) - 0.01, 0.4, $SupportHeight / 2])
      rotate(90, [0, 1, 0])
  ...
  if ($DoHorizontal == true)
  {
    ...
    translate([0, 1.3, 0])
      difference()
      {
        ...
        translate([0, 0.25, 1])
          rotate(90, [0, 1, 0])
            cylinder(d = 7/32, h = 2, $fn = 20, center = true);
        translate([0, 0.95, 1])
          rotate(90, [0, 1, 0])
            cylinder(d = 7/32, h = 2, $fn = 20, center = true);
      }
...
module ControlDriveMount($ShowServo = false)
{
  translate([0, -1, -1.35])
  {
      difference()
      {
        ...
        {
          //Main base
          translate([0.25, 0.345, -0.775])
            cube([1.75, 1.3, 3]);
          //Horizontal mounting plate
          translate([0.25, -0.455, 1.925])
            cube([1.75, 2.8, .3]);
        }
...
module ControlDriveWheelAssembly()
{
  ...
  translate(-$ControlWheelOffset)
  {
    //Drive wheel
    color([.4, .3, .5])
      cylinder(d = 2.9, h = $ControlWheelContactorHeight, $fn = 20);
    //Spindle
...
{ 
  ...
  */
  if ($DoSides == true)
  {
    translate([(-2.5 / 2)-0.1 + 0.68, (-4.5 / 2), -3])
      LBar($L = 9.7);
    mirror([0, 1, 0])
      translate([(-2.5 / 2)-0.1 + 0.68, (-4.5 / 2), -3])
        LBar($L = 9.7);
  ...
  if ($DoTop == true)
  {
    ...
    difference()
    {
      translate([-0.325 + 0.34, 0, 0.45])
        cube([1.5 + 0.55 - 0.68, 4.5, .5], center = true);
      //Spindle bearing
      translate([0, 0, .19])
      {
        scale(1/25.4)
          BearingReceptical($Type="608",  $DOversize = .5, $HOversize = 1);
        cylinder(d = $CWShaftDiameter + $CWShaftClearance, h = 2, $fn = 20, center = true);
      }
      //Support cutouts
      translate([(-2.5 / 2)-0.101 + 0.68, (-4.5 / 2) - 0.001, 0])
        LBar($L = 1);
      mirror([0, 1, 0])
        translate([(-2.5 / 2)-0.101 + 0.68, (-4.5 / 2) - 0.001, 0])
          ...
          LBar($L = 1);
      //Support bolt holes
      translate([0.71, 2.1 - 0.25, 0.45])
        CaptiveBoltOpening($Type = "M4", $ShaftLength = 40, $Angle = -90, $Orientation = [0,1, 0], $Units = 1/25.4);//Units are mm
      mirror([0, 1, 0])
        translate([0.71, 2.1 - 0.25, 0.45])
          CaptiveBoltOpening($Type = "M4", $ShaftLength = 40, $Angle = -90, $Orientation = [0,1, 0], $Units = 1/25.4);//Units are mm
    }
  ...
  if ($DoBase == true)
  {
    difference()
    {
        ...
        translate([-1.74, 0, 0])
          translate($ControlWheelOffset)
            difference()
            {
              ...
              translate([-0.01, -0.475, -1.09])
                cube([.5, .95, .5]);
            }
      }
      //Support cutouts
      translate([(-2.5 / 2)-0.101 + .68, (-4.5 / 2) - 0.001, -3.1])
      {
        LBar($L = 2.5);
        translate([-.7, 0, 0])
          cube([.8, .64, 2.2]);
      ...
      //Support bolt holes
      translate([1.151, -2.1 + 0.25, -1.35])
        CaptiveBoltOpening($Type = "M4", $ShaftLength = 50, $Angle = -90, $Orientation = [0,1, 0], $Units = 1/25.4, $DepthCorrection = 0, $BoreCorrection = .5);//Units are mm
      translate([1.151, -2.1 + 0.25, -1.35 - 1.25])
        CaptiveBoltOpening($Type = "M4", $ShaftLength = 50, $Angle = -90, $Orientation = [0,1, 0], $Units = 1/25.4, $DepthCorrection = 0, $BoreCorrection = .5);//Units are mm
      mirror([0, 1, 0])
      {
        translate([(-2.5 / 2)-0.101 + .68, (-4.5 / 2) - 0.001, -3.1])
      ...
      translate($ControlWheelOffset)
      {
       ...
       rotate(90, [0, 1, 0])
        ...
        translate([-2.5, 0, 0])
          rotate(90, [0, 1, 0])
            cylinder(d = $CWShaftDiameter + (0.5/25.4), h = 2, $fn = 20);
        //Rotation bolt head
...
module ShooterAnglerUpperPivotV2()
{
  
  $InnerBoreDiameter = 0.32;
  $BearingDiameter = 0.52;
  $BearingThickness = 0.18;
  $BearingYOffset = 1.16;
  $BlockThickness = 0.75;
  $BlockLength = $PivotOffset + 0.45;
  $BlockHeight = 1.52;
  $MountCutoutHeight = 0.63;
  $SupportLength = 1.55;
  $MountCutoutLength = $BlockLength - $SupportLength;
  
  translate([2.25 - $PivotOffset, 0, 0])
  {
    difference()
    {
      cube([$BlockLength, $BlockHeight, $BlockThickness]);
      translate([$PivotOffset, .5, -0.001])
      {
        cylinder(d = 0.42, h = 1, $fn = 30);
        translate([0.31, 0, 0])
          cylinder(d = 0.1, h = 1, $fn = 30);
        translate([-0.31, 0, 0])
          cylinder(d = 0.1, h = 1, $fn = 30);
        translate([0, 0.31, 0])
          cylinder(d = 0.1, h = 1, $fn = 30);
      ...
      translate([-0.0005, $BearingYOffset, ($BlockThickness / 2)])
        rotate(90, [0, 1, 0])
        {
          cylinder(d = $InnerBoreDiameter, h = 4, $fn = 30);
          cylinder(d = $BearingDiameter, h = $BearingThickness, $fn = 30);
          translate([0, 0, $PivotOffset + 0.45 - $BearingThickness - $MountCutoutLength + 0.002])
            cylinder(d = $BearingDiameter, h = $BearingThickness, $fn = 30);
        }
//      translate([$PivotOffset + 0.45 - $MountCutoutLength + 0.001, $BlockHeight - $MountCutoutHeight + 0.001, - 0.1])
      translate([$PivotOffset + 0.45 - $MountCutoutLength + 0.001, $BlockHeight - $MountCutoutHeight + 0.001, - 0.1])
        cube([$MountCutoutLength, $MountCutoutHeight, $BlockThickness + 0.2]);
      translate([0, 0.8, 0])
        rotate(-18, [0, 0, 1])
          translate([0, -3, -0.1])
            cube([3, 3, $BlockThickness + .2]);
    }
  }
}

module ShooterAngler2021()
{
  translate([-1, .65, 3])
    ShooterAnglerUpperPivotV2();
  
  ShooterAnglerLowerSupport();
  translate([-$SupportSideWidth - $Clearance, 2, 0])
    ShooterAnglerPivotSupport($FrameWidth = $LowerSupportWidth, $VerticalMountSpacing, $DoVertical = true);
  translate([1.25, 1.15, 0])
  cylinder(d = 8/25.4, h = 8, $fn = 30);
}

/*
ShooterAnglerUpperPivotV2($PivotOffset = 2.5);
translate([0, 1.4, 0])
  ShooterAnglerUpperPivotV2($PivotOffset = 2.5 - 0.25);
translate([0, 1.4 * 2, 0])
  ShooterAnglerUpperPivotV2($PivotOffset = 2.5 - 0.25 - 0.25);
translate([0, 1.5 * 3, 0])
  ShooterAnglerUpperPivotV2($PivotOffset = 2.5 + 0.25);
*/