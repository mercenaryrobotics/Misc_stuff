...
- rack (module, length, height, width, pressure angle = 20, helix angle = 0)
- spur gear (module, number of teeth, width, bore, pressure angle = 20, helix angle = 0, optimized = true)
- arrow wheel (module, number of teeth, width, bore, pressure angle = 20, helix angle = 0, optimized = true)
- rack_and_wheel (module, length_staff, number of teeth_wheel, height_staff, bore_rad, width, pressure angle = 20, helix angle = 0, assembled_ = true, optimized = true)
- ring gear (module, number of teeth, width, edge width, pressure angle = 20, helix angle = 0)
- arrow ring gear (module, number of teeth, width, edge width, pressure angle = 20, helix angle = 0)
- planetary gear (module, number of teeth_sun, number of teeth_planet, number of planets, width, edge width, bore, pressure angle = 20, helix angle = 0, assembled_ = true, optimized = true)
- bevel gear (module, number of teeth, pitch angle, tooth width, bore, pressure angle = 20, helix angle = 0)
- arrow bevel gear (module, number of teeth, pitch angle, tooth width, bore, pressure angle = 20, helix angle = 0)
- bevel gear pair (module, number of teeth_wheel, number of teeth_ pinion, axis angle = 90, tooth width, bore, pressure angle = 20, helix angle = 0, assembled_ = true)
- Arrow bevel gear pair (module, number of teeth_wheel, number of teeth_wheel, axis angle = 90, tooth width, bore, pressure angle = 20, helix angle = 0, assembled_ = true)
- worm (module, number of turns, length, bore, pressure angle = 20, helix angle = 10, assembled_ = true)
- worm gear set (module, number of teeth, number of threads, width, length, bore_worm, bore_wheel, pressure angle = 20, lead angle = 0, optimized = true, assembled_ = true)
...
module kegelradpaar(modul, zahnzahl_rad, zahnzahl_ritzel, achsenwinkel=90, zahnbreite, bohrung_rad, bohrung_ritzel, eingriffswinkel=20, schraegungswinkel=0, zusammen_gebaut=true){
	...
	// Zeichnung
	// Rad
	echo (str("GEAR1 : kegelrad(", modul, ",", zahnzahl_rad, ",", delta_rad, ",", zahnbreite, ",", bohrung_rad, ",", eingriffswinkel, ",", schraegungswinkel, ");"));
	...
	// Ritzel
	echo (str("GEAR2 : kegelrad(", modul, ",", zahnzahl_ritzel, ",", delta_ritzel, ",", zahnbreite, ",", bohrung_ritzel, ",", eingriffswinkel, ",", -schraegungswinkel, ");"));
	if (zusammen_gebaut)
...
// rack (module = 1, length = 30, height = 5, width = 5, pressure angle = 20, helix angle = 20);
// zahnstange(modul=1, laenge=30, hoehe=5, breite=5, eingriffswinkel=20, schraegungswinkel=20);

// spur gear (module = 1, number of teeth = 30, width = 5, bore = 4, pressure angle = 20, helix angle = 20, optimized = true);
// stirnrad (modul=1, zahnzahl=30, breite=5, bohrung=4, eingriffswinkel=20, schraegungswinkel=20, optimiert=true);

// arrow wheel (module = 1, number of teeth = 30, width = 5, bore = 4, pressure angle = 20, helix angle = 30, optimized = true);
// pfeilrad (modul=1, zahnzahl=30, breite=5, bohrung=4, eingriffswinkel=20, schraegungswinkel=30, optimiert=true);

// rack_and_wheel (module = 1, length_staff = 50, number of teeth_wheel = 30, height_staff = 4, bore_rad = 4, width = 5, pressure angle = 20, helix angle = 0, assembled_ = true, optimized = true);
...
// ring gear (module = 1, number of teeth = 30, width = 5, edge width = 3, pressure angle = 20, helix angle = 20);
// hohlrad (modul=1, zahnzahl=30, breite=5, randbreite=3, eingriffswinkel=20, schraegungswinkel=20);

// arrow ring gear (module = 1, number of teeth = 30, width = 5, edge width = 3, pressure angle = 20, helix angle = 30);
// pfeilhohlrad (modul=1, zahnzahl=30, breite=5, randbreite=3, eingriffswinkel=20, schraegungswinkel=30);

// planetary gear (module = 1, number of teeth_sun = 16, number of teeth_planet = 9, number of planets = 5, width = 5, edge width = 3, bore = 4, pressure angle = 20, helix angle = 30, assembled_ = true, optimized = true);
...
// bevel gear (module = 1, number of teeth = 30, pitch angle = 45, tooth width = 5, bore = 4, pressure angle = 20, helix angle = 20);
...
// bevel gear pair (module = 1, number of teeth gear = 30, number of teeth pinion = 11, axis angle = 100, tooth width = 5, bore = 4, pressure angle = 20, helix angle = 20, assembled_ = true);
...
// bevel gear pair (module = 1, number of teeth gear = 30, number of teeth pinion = 11, axis angle = 100, tooth width = 5, bore_rad = 3, bore_pinion = 3, pressure angle = 20, helix angle = 20, assembled_ = true);
...
// arrow bevel gear pair (module = 1, number of teeth gear = 30, number of teeth pinion = 11, axis angle = 100, tooth width = 5, bore_rad = 3, bore_pinion = 3, pressure angle = 20, helix angle = 30, assembled_ = false);
...
// worm (module = 1, number of turns = 2, length = 15, bore = 4, pressure angle = 20, helix angle = 10, assembled_ = true);
// schnecke(modul=1, gangzahl=2, laenge=15, bohrung=4, eingriffswinkel=20, steigungswinkel=10, zusammen_gebaut=true);

// worm gear set (module = 1, number of teeth = 30, number of turns = 2, width = 8, length = 20, bore_worm = 4, bore_wheel = 4, pressure angle = 20, lead angle = 10, optimized = true, assembled = true);
